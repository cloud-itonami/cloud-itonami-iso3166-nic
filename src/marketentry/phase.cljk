(ns marketentry.phase
  "Phase 0->3 staged rollout for the Republic of Nicaragua (NIC)
  ...
  real DGCE filing package and submitting a real filing / Registro
  Público Mercantil inscription request are the two real-world acts
  this actor performs; both are always a human market-entry operator's
  call. `marketentry.governor`'s `:actuation/draft-filing`/`:actuation/
  submit-filing` high-stakes gate enforces the same invariant
