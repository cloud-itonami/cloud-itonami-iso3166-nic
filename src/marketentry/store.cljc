(ns marketentry.store
  "SSoT for the Republic of Nicaragua (NIC) market-entry compliance
...
(defn demo-data
  ...
  `:contract-value-cordobas` / `:claimed-certificado-requerido?` are
  ground truth for the `certificado-verificacion-claim-mismatch`
  flagship check (Ley 1238 Art. 18 numeral 6 / Art. 29 numeral 4
  Contratación Menor threshold); `:certificado-verificado?` is ground
  truth for the conditional Comisión de Verificación de Proveedores del
  Estado check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Managua Inversiones del Pacífico S.A." :portal "DGCE / SISCAE (www.nicaraguacompra.gob.ni)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :contract-value-cordobas 5000000.0
             :claimed-certificado-requerido? true :certificado-verificado? true
             :drafted? false :submitted? false
             :jurisdiction "NIC" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "DGCE / SISCAE (www.nicaraguacompra.gob.ni)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :contract-value-cordobas 5000000.0
             :claimed-certificado-requerido? true :certificado-verificado? true
    ...
    "eng-3" {:id "eng-3" :operator "León Comercializadora del Norte S.A." :portal "DGCE / SISCAE (www.nicaraguacompra.gob.ni)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "NIC" :status :intake}
    "eng-4" {:id "eng-4" :operator "Granada Logística Portuaria S.A." :portal "DGCE / SISCAE (www.nicaraguacompra.gob.ni)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :contract-value-cordobas 2500000.0
             :claimed-certificado-requerido? false :certificado-verificado? true
             :drafted? false :submitted? false
             :jurisdiction "NIC" :status :intake}
    "eng-5" {:id "eng-5" :operator "Chinandega Agroindustrial S.A." :portal "DGCE / SISCAE (www.nicaraguacompra.gob.ni)"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :contract-value-cordobas 5000000.0
             :claimed-certificado-requerido? true :certificado-verificado? false
             :drafted? false :submitted? false
             :jurisdiction "NIC" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               contract-value-cordobas claimed-certificado-requerido? certificado-verificado?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    contract-value-cordobas               (assoc :engagement/contract-value-cordobas contract-value-cordobas)
    (some? claimed-certificado-requerido?) (assoc :engagement/claimed-certificado-requerido? claimed-certificado-requerido?)
    (some? certificado-verificado?)        (assoc :engagement/certificado-verificado? certificado-verificado?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/contract-value-cordobas :engagement/claimed-certificado-requerido? :engagement/certificado-verificado?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :contract-value-cordobas (:engagement/contract-value-cordobas m)
     :claimed-certificado-requerido? (boolean (:engagement/claimed-certificado-requerido? m))
     :certificado-verificado? (boolean (:engagement/certificado-verificado? m))
